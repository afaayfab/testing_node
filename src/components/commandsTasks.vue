...
export default {
    ...
    data() {
        return {
            jsonSource: [],
    //            [{"type":"task-received","uuid":"279f7c2d-9d15-4e63-bb8e-3012becfc718","rootId":null,"parentId":null,"v-key-node('pruebas',)":6,"children":[{"uuid":"81b1d827-1bee-404c-9a19-029167c16f52","v-key-node('WORK-0',)":2,"children":[{"uuid":"73e8806a-f2ba-4698-bc70-bf7547c0a233","v-key-node('JOB-0',)":2,"children":[{"uuid":"14662be0-55df-499c-94da-9681b86d3bac","v-key-node('PROCESS-0',)":2,"children":[]},{"uuid":"e7fb9d03-7f13-4b6d-a2c6-72469ab47abf","v-key-node('PROCESS-1',)":2,"children":[]}]},{"uuid":"3e558423-bd1a-46aa-ab55-587479ad6fa4","v-key-node('JOB-1',)":2,"children":[{"uuid":"bba88b00-bcd1-4856-b5d1-ec4adbb9f51b","v-key-node('PROCESS-0',)":2,"children":[]},{"uuid":"aca79bb5-d892-41b3-8821-44392589194d","v-key-node('PROCESS-1',)":2,"children":[]}]}]},{"uuid":"dcbf9ca9-f3bc-4884-96ab-14d0443a6b6e","v-key-node('WORK-1',)":2,"children":[{"uuid":"d0a5e624-5c53-4710-aabb-1e027bc5755e","v-key-node('JOB-0',)":2,"children":[{"uuid":"a6eda20c-7af7-4308-8e24-8b49e8e598ab","v-key-node('PROCESS-0',)":2},{"uuid":"de163b90-968a-4774-a57a-80c0c89899d6","v-key-node('PROCESS-1',)":2}]},{"uuid":"0b604bd4-9d60-4ede-a452-f1c03778f49c","v-key-node('JOB-1',)":2,"children":[{"uuid":"9b9228b2-c4c5-41be-bc31-df7ffca5e299","v-key-node('PROCESS-0',)":2},{"uuid":"41357429-3519-41f7-9878-199afa5c732e","v-key-node('PROCESS-1',)":2}]}]}]}]
